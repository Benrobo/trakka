...
function NavBar() {
    ...
    return (
        <React.Fragment>
            <div className={`relative h-auto w-screen bg-dark-200 flex items-center justify-between p-2 shadow-2xl`}>
                <h2 className="text-green-200 font-extrabold  ">Trakka</h2>
